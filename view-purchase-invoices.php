            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>View Purchase Invoice Details</h5>
                        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px; margin-top: 30px;">
                            <!-- Form for Month and Year Selection -->
                            <form class="form-inline" method="POST" action="download_purchase_invoice_monthly.php" style="display: flex; align-items: center;">
                            ...
                            <form class="form-inline" method="POST" action="download_purchase_invoice_range.php" style="display: flex; align-items: center; margin-right: 10px;">
                            ...
                            <a href="create-purchase-invoice.php" class="btn btn-info" style="color: #fff !important;">Create</a>
                        </div>
                    </div>
...
<a href="create-work-order.php?id='.$row['iid'].'&qcode='.$row['quotationNumber'].'" class="btn btn-primary btn-sm">
