...
// Output JavaScript to display the payload in an alert
echo "<script>";
...
<div class="col-6" id="bank_name_tab" >
    <div class="form-group">
        ...
        <input type="text" class="form-control m-input form-control-sm" id="bank_name" placeholder="Bank Name" value="<?php echo isset($quotationDetails['bank_name']) ? $quotationDetails['bank_name'] : ''; ?>">
    </div>
</div>
