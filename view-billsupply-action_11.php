...
<!-- <iframe id="pdfViewer" src="<?php echo $quotationDetails['bill_file']; ?>" width="100%" height="600px"></iframe> -->
            ...
            <div class="panel-body" style="border: 1px solid black;padding: 10px;border-radius: 4px;">
                <div class="row">
                    ...
                    <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 text-right">
                        ...
                        <h5 class="line-height-70"> <b>INVOICE #: <span id="inv_no"><?php echo $quotationDetails['bill_code']?></span></b></h5>
                        <h5 class="line-height-70">Date: <span id="inv_date"><?php echo $quotationDetails['bill_date']?></span></h5>
...
$query1 = "SELECT * FROM receipts WHERE invoice_id = '$bill_id'";
$result1 = $conn->query($query1);

if ($result1->num_rows > 0) {
    echo "payment data found for the given bill of supply ID.";
