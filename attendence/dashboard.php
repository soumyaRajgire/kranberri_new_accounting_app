...
<section class="pcoded-main-container">
    ...
    <?php
        ...
        $sql = "SELECT grand_total FROM quotation WHERE quotation_date >= '$firstDay' AND due_date <= '$lastDay'";
        ...
        if ($result) {
            ...
            echo '<a href="" class="btn btn-warning" style="float: right; margin-top: -60px;">INR ' . number_format($grandTotal) . '</a>';
    ...
    ?>
       ...
       if ($result) {
           ...
           echo '<a href="" class="btn btn-success" style="float: right; margin-top: -60px;">INR ' . number_format($grandTotal) . '</a>';
...
?>
       ...
       // SQL query to fetch the grand_total for the current month
       $sql = "SELECT SUM(grand_total) FROM purchase_order WHERE order_date >= '$firstDay' AND due_date <= '$lastDay'";
   ...
   ?>
       ...
       // SQL query to fetch the grand_total for the current month
       $sql = "SELECT SUM(grand_total) FROM purchase_invoice WHERE pinvoice_date >= '$firstDay' AND due_date <= '$lastDay'";
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <div class="col-md-12 mt-4">
                        <ul class="d-flex pl-0 mb-0 align-items-center" style="list-style:none;">
                            ...
                            <a class="btn btn-danger border-bottom-0 border-left-0 kt-font-bold btn-block"
                        href="" onclick="openBankPopup();">Add Bank Account</a>
                            </li>                           
                        </ul>                   
                    </div>
                    </div>
