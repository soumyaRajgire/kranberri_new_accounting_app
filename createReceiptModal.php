...
<input type="text" name="business_state" id="business_state" value="<?php echo htmlspecialchars($user['state']); ?>" hidden>
   ...
   <h5 class="line-height-70 mb-1"><b id="seller_name" style=" color: blue;"><?php echo htmlspecialchars($user['branch_name']); ?></b></h5>
       <h5 id="seller_add_1" class="line-height-70 mb-1"><?php echo htmlspecialchars($user['address_line1']); ?> </h5>
        <h5 id="seller_add_2" class="line-height-70 mb-1"><?php echo htmlspecialchars($user['address_line2']);?></h5>
        <h5 id="seller_add_3" class="line-height-70 mb-1">GST : <?php echo htmlspecialchars($user['GST']); ?></h5>
        <h5 id="seller_email" class="line-height-70 mb-1"> Email: <?php echo htmlspecialchars($user['email']); ?> </h5>
        <h5 id="seller_mobile" class="line-height-70 mb-1">Phone: <?php echo htmlspecialchars($user['phone_number']); ?> </h5>
                            </div>
                            </div>
                        </div>
                        <div class=" col-md-5">
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                  ...
                                  <div class="input-group-append" style="width:70%">
                                     <input type="number" min="0" step="0.01" id="amount" name="amount" class="form-control total_amt" placeholder="Amount" value="<?php echo $payableAmount; ?>"  max="<?php echo $payableAmount; ?>"
...
<div class="row" style="padding:10px;">
   ...
   <input type="text" name="invoice_pid" value="<?php echo isset($quotationDetails['invoice_id']) ? $quotationDetails['invoice_id'] : (isset($bill_id) ? $bill_id : ''); ?>" hidden>

  <input type="text" name="invoice_code" value="<?php echo isset($quotationDetails['invoice_code']) ? $quotationDetails['invoice_code'] : (isset($quotationDetails['bill_code']) ? $quotationDetails['bill_code'] : ''); ?>" hidden>
