                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">Party Wise Purchase Report</h4>
                            </div>
                            <ul class="breadcrumb" style="float: right; margin-top:-40px;">
                                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">Party Wise Purchase Report</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5>View Party Wise Purchase Reports</h5>
...
<div id="reportsSidebar">
    ...
    <h4>Reports</h4>
    <h6>Party Wise Purchase Report</h6>
<hr>
...
<form id="downloadReports" action="downloadCurrentStockReports.php" method="POST">
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchStockData() {
        $.ajax({
            url: "fetch_party_wise_purchase_report.php",
            method: "POST",
            data: {
    ...
    <script src="assets/js/myscript.js"></script>
     <script>
        $(function() {
            ...
            $("#reportsSidebar #from_date").datepicker({
                dateFormat: "dd/mm/yyyy"
            });
            $("#reportsSidebar #to_date").datepicker({
                dateFormat: "dd/mm/yyyy"
            });
        });
    </script>
