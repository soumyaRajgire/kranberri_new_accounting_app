<div id="addSuppliersModal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    ...
    <form action="contactsdb.php" method="POST">
        <input type="hidden" name="contact_type" id="contact_type" value="Suppliers">
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="input-group-prepend">
            ...
            <div class="did-floating-label-content">
                <input type="text" class="did-floating-input" placeholder="" name="name" id="name">   
                <label for="" class=" did-floating-label">Name</label></div>
            </div>
    </div>
