...
opening_stock = VALUES(opening_stock)";
    ...
    $batch_no = mysqli_real_escape_string($conn, $batch_no);
    ...
    $batch_price = mysqli_real_escape_string($conn, $prices[$index]);
    $batch_inclusive_gst = mysqli_real_escape_string($conn, $batch_inclusive_gsts[$index]);
    $batch_gst_rate = mysqli_real_escape_string($conn, $gst_rates[$index]);
    $batch_non_taxable = mysqli_real_escape_string($conn, $non_taxables[$index]);
    $batch_net_price = mysqli_real_escape_string($conn, $net_prices[$index]);
    $hsn_code = mysqli_real_escape_string($conn, $hsn_codes[$index]);
    $unit = mysqli_real_escape_string($conn, $units[$index]);
    $batch_cess_rate = mysqli_real_escape_string($conn, $cess_rates[$index]);
    $batch_cess_amount = mysqli_real_escape_string($conn, $batch_cess_amounts[$index]);
    $sku = mysqli_real_escape_string($conn, $skus[$index]);
    $opening_stock = mysqli_real_escape_string($conn, $opening_stocks[$index]);
    $opening_stockdate = mysqli_real_escape_string($conn, $opening_stockdates[$index]);
    $min_stockalert = mysqli_real_escape_string($conn, $min_stockalerts[$index]);
    $max_stockalert = mysqli_real_escape_string($conn, $max_stockalerts[$index]);
