        ...
        <div class="col-md-6 col-lg-6">
            <ul class="nav">
                <li class="nav-item mt-2">
                    <h5><a href="#" class="customer_est_name text-primary"  style="font-size: 19px;">Customer: <?php echo $invoiceDetails['customerName'];?></a></h5>
                </li>
            </ul>
        </div>
...
if($invoiceDetails['status'] == "paid")
{
 ?>
  ...
  <?php
}else if($invoiceDetails['status'] == "pending" || $invoiceDetails['status'] == "partial")
{
    ?>
...
<div class="btn-group">
    ...
    <a href="" class="btn border border-grey" onclick="printPDF('<?php echo $invoiceDetails['invoice_file']?>')" data-toggle="tooltip" data-placement="top" title="Print"><i class="fa fa-print text-grey" aria-hidden="true"></i> </a>
    <a href="<?php echo $invoiceDetails['invoice_file']?>" target="_blank" class="btn border border-grey" data-toggle="tooltip" data-placement="top" title="Download"><i class="fa fa-download text-grey" aria-hidden="true"></i></a>
...
<!-- <iframe id="pdfViewer" src="<?php echo $invoiceDetails['invoice_file']; ?>" width="100%" height="600px"></iframe> -->
            ...
            <div class="panel-body" style="border: 1px solid black;padding: 10px;border-radius: 4px;">
                <div class="row">
                    ...
                    <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 text-right">
                        ...
                        <h5 class="line-height-70"> <b>INVOICE #: <span id="inv_no"><?php echo $invoiceDetails['invoice_code']?></span></b></h5>
                        <h5 class="line-height-70">Date: <span id="inv_date"><?php echo $invoiceDetails['invoice_date']?></span></h5>
                        <h5 class="line-height-70">Due Date: <span id="inv_due_date"><?php echo $invoiceDetails['due_date']?></span></h5>
                        <p id="inv_cancel_status" style="display:none;">0</p>
                        <p id="inv_delete_status" style="display:none;">0</p>
                    <p id="inv_added_by">Created By: <?php echo $invoiceDetails['created_by']?></p>
                        <?php 
                        if($invoiceDetails['status'] == "pending")
                        {
                            ...
                            <?php
                        }else if($invoiceDetails['status'] == "partial")
                        {
                            ?>
                ...
                <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-left mt-3">
                        <h4><b>Customer</b></h4>
                        <h6><span class="" id="cust_name"><?php echo $invoiceDetails['customerName']?></span></h6>
                        <h6><span class="line-height-70" id="cust_email"><?php echo $invoiceDetails['email'];?></span></h6>
                        <h6><span class=""><span>GSTIN : </span><?php echo $invoiceDetails['gstin']?></span></h6>
                        <h6><span class="" id="cust_supply_state"><span>Place of Supply :</span> <?php echo $invoiceDetails['s_state']?> </span></h6>
                    </div>
                ...
                <div class="row mt-1" style="padding: 1px;">
                    <div id="charges_div" class="col-xs-12 col-md-12 col-lg-12">
                        <table class="table-responsive table-condensed table table-bordered" style="text-size: 15px;">
                            ...
                            <tbody>
                                <?php if (isset($invoiceDetails['quotation_items']) && is_array($invoiceDetails['quotation_items'])) : ?>
                                    <?php
                ...
                $line_tot_amt = 0;
            ?>
            <?php foreach ($invoiceDetails['quotation_items'] as $item) : ?>
...
?>
            ...
            <?php endif; ?>
                            ...
                            <tfoot>
                                <!-- <tr class="no-border">
                                    ...
                                    <td style="border-bottom: 0px;" class="text-right"><b><i class="fas fa-rupee-sign"></i> <span id="tot_payable"><?php echo $invoiceDetails['grand_total'];?></span></b></td>
                                </tr> -->
                               <!-- <tr>
                                ...
                                <tr>
                                    <td colspan="6" rowspan="3">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-border-top no-border-bottom" style="padding: 5px; min-height: 100px;">
                                            <p style="text-align: left; font-size: 16px;"><small><b>Terms &amp; Conditions:</b><br></small><span><?php echo $invoiceDetails['terms_condition']?></span></p>
                                        </div>
                                    </td>
    ...
    <td class="text-right"><b><span><?php echo $invoiceDetails['grand_total']; ?></span></b></td>
</tr>
<tr>
    <td colspan="3" class="text-left" style="font-size: 16px;">
        <small><b>Amount: <?php echo numberToWordsFloat($invoiceDetails['grand_total']); ?>.</b></small>
    </td>
</tr>
        ...
        <div class="card">
            <div class="card">
                ...
                <div class=" row pl-1 pr-1 ml-0 mr-0" style="border-bottom:1px dashed gray">
                    <div class="col-md-7 p-3">
                        <span>Invoiced</span><br/>
                         <span><?php echo "(On " . date('d-m-Y', strtotime($invoiceDetails['invoice_date'])) . ")"?></span> 
                    </div>
                ...
                <div class="row pl-3 pr-3">
                    <div class="col-md-7 p-3">
                         <?php
    $lastPaymentDate = $invoiceDetails['invoice_date'];
    $dueDate = date('Y-m-d', strtotime($invoiceDetails['due_date'] . ' +1 day')); // Consider entire day on due date
...
<script>
    function printPDF(pdfFilePath) {
        const printWindow = window.open(pdfFilePath, '_blank');
