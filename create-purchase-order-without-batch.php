      ...
      <div class="page-header">
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h4 class="m-b-10">Create Purchase Order</h4>
                        </div>
                        <ul class="breadcrumb" style="float: right; margin-top:-40px;">
                            <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Create Purchase order</a></li>
                            <!-- <li class="breadcrumb-item"><a href="#!">Basic Tables</a></li> -->
                        </ul>
                    </div>
                </div>
    ...
    <div class="table-responsive">
      <div class="row">
        <div class="col-sm-12">
          <div class="">
            <div class="card-body">
              <form id="" action="save_po.php" method="POST">
...
<span style="color:skyblue;">GSTIN: 29AAICK7493G1ZX</span>
                    ...
                    <div class="col-md-4 pt-1">
                        ...
                        <?php
                          $result1=mysqli_query($conn,"select id from purchase_orders where id=(select max(id) from purchase_orders)");
  if($row1=mysqli_fetch_array($result1))
  {
    $id=$row1['id']+1;
    $i=$row1['id'];
    $s=preg_replace("/[^0-9]/", '', $i);
    $invoice_code="PO0".($s+1);
 }
 else{
  $id = 0;
  $invoice_code = "PO0".(1);
...
<input class="form-control" type="text" id="invoice_code" value="<?php echo $invoice_code; ?>"  name="invoice_code" required/>
                <label class="form-control col-sm-5" for="invoice_code">Purchase Order No</label>
                        ...
                        <div class="py-1 input-group">
    <input class="form-control" type="date" id="purchaseDate" name="invoice_date" required />
    <label class="form-control col-sm-5" for="invoice_date">Date</label>
</div>
<div class="py-1 input-group">
    <input class="form-control" type="date" id="dueDate" name="due_date" required>
