...
file_put_contents($filename, $pdfdoc);
  ...
  $sql="INSERT INTO purchase_order (`id`, `order_code`, `order_file`,`customer_id`, `email`, `order_date`, `due_date`, `total_amount`,`total_tax`, `grand_total`,  `terms_condition`, `note`,`status`, `created_by`) VALUES ('$id', '$order_code','$filename','$cst_mstr_id', '$customer_email', '$orderDate', '$dueDate', '$pricevaltot', '$gsttot','$tot_amt', '$terms', '$note','pending', '$created_by')";
 ...
 ?>
    ...
    <script>
      window.location="create-purchase_order.php";
