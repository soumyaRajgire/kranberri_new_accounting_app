...
<body>
    ...
    <a href="product_wise_sales_report.php">
        <div class="report-card shadow text-center p-3">
            <img src="bank-icon1.png" class="img-fluid mx-auto d-block" style="width: 50px; height: 50px;" />
            <div class="report-title mt-2">Product Wise Sales Report</div>
        </div>
    </a>
</div>
            ...
            <div class="col-md-4 mb-4">
                <a href="party_wise_purchase_report.php">
                    <div class="report-card shadow">
                    <img src="bank-icon1.png" class="img-fluid mx-auto d-block" style="width: 50px; height: 50px;" />
                        <div class="report-title">Party Wise Purchase Report</div>
                    </div>
            ...
            <div class="col-md-4 mb-4">
                ...
                <div class="report-card shadow">
                <img src="bank-icon1.png" class="img-fluid mx-auto d-block" style="width: 50px; height: 50px;" />
                    <div class="report-title">GSTR-1</div>
                </div>
                </a>
            </div>
            <!-- <div class="col-md-4 mb-4">
            ...
            <div class="col-md-4 mb-4">
                ...
                <div class="report-card shadow">
                <img src="bank-icon1.png" class="img-fluid mx-auto d-block" style="width: 50px; height: 50px;" />
                    <div class="report-title">GSTR-2</div>
                </div>
                </a>
            </div>
            <!-- <div class="col-md-4 mb-4">
            ...
            <div class="col-md-4 mb-4">
                <a href="invoice_details_report.php">
                <div class="report-card shadow">
                <img src="bank-icon1.png" class="img-fluid mx-auto d-block" style="width: 50px; height: 50px;" />
                    <div class="report-title">Invoice Details Reports</div>
                </div>
                </a>
            </div>
            <div class="col-md-4 mb-4">
            ...
            <div class="col-md-4 mb-4">
                <a href="delivery_challan_report_details.php">
                <div class="report-card shadow">
                <img src="bank-icon1.png" class="img-fluid mx-auto d-block" style="width: 50px; height: 50px;" />
                    <div class="report-title">Delivery Challan Details Reports</div>
                </div>
                </a>
            </div>
            <div class="col-md-4 mb-4">
                ...
                <div class="report-card shadow">
                <img src="bank-icon1.png" class="img-fluid mx-auto d-block" style="width: 50px; height: 50px;" />
                <i class="fas fa-history fa-3x mb-2 text-primary"></i>
