        ...
        $.ajax({
            ...
            success: function (branches) {
                ...
                $.each(branches, function (index, branch) {
                    branchDropdown.append($('<option>', { value: branch.id, text: branch.officeName }));
                });
            },
        ...
        $.ajax({
            ...
            success: function (departments) {
                ...
                $.each(departments, function (index, department) {
                    departmentDropdown.append($('<option>', { value: department.id, text: department.departmentName }));
                });
            },
            error: function (error) {
                // Handle errors (you can show an error message to the user)
        ...
        $.ajax({
            ...
            success: function (designations) {
                ...
                $.each(designations, function (index, designation) {
                    designationDropdown.append($('<option>', { value: designation.id, text: designation.designationName }));
                });
            },
            error: function (error) {
                // Handle errors (you can show an error message to the user)
