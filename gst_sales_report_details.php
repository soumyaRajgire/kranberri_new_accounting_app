                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">GST Sales Details Report</h4>
                            </div>
                            <ul class="breadcrumb" style="float: right; margin-top:-40px;">
                                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">GST Sales Details Report</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5>View GST Sales Details Reports</h5>
...
<div id="reportsSidebar">
    ...
    <h4>Reports</h4>
    <h6>GST Sales Details Report</h6>
<hr>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    $.ajax({
        url: "fetch_gst_sales_report_details.php",
        method: "POST",
        data: {
