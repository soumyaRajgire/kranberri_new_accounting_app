...
<!-- [ Main Content ] start -->
        ...
        <?php
          function getinvoiceDetails($conn, $inv_id) {
            ...
            $query = "
            SELECT q.*, c.*, a.*, qi.*, im.in_ex_gst, im.net_price, im.gst_rate, im.price 
                      FROM invoice q
 ...
 //echo json_encode($invoiceItems, JSON_PRETTY_PRINT);
          ...
          <div class="table-responsive">
            <div class="row">
              <div class="col-sm-12">
                <div class="">
                  <div class="card-body">
                    <form action="save_quotation.php" method="POST" enctype="multipart/form-data">
                              ...
                              <!-- <td>${prodDesc ? prodDesc : 'No description'}<input type="hidden" name="products[${count}][pdesc]" value="${prodDesc}"></td> -->
                                                                 <td>
                                                                     ...
                                                                     <?php echo $item['product']; ?>
                                                                        ...
                                                                        <!--<input type="hidden" class="form-control" name="products[<?php echo $index; ?>][productids]"                                                                         value="<?php echo $item['product_id']; ?>" > -->
