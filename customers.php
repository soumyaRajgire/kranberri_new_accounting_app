...
<body class="">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                 ...
                                 <div class="col-md-12">
                                     <h4 class="m-b-10">View Customers</h4><hr/>
                                    <!-- Download Options -->
    ...
    <span></span> <i class="fa fa-caret-down"></i>
                                      ...
                                      <!--  <form class="form-inline" method="POST" action="download_customers_range.php" style="display: flex; align-items: center; margin-right: 10px;">
                                        ...
                                        <!-- Add Customer Button -->
                                        <form action="customer_form.php" method="POST" style="margin-left: auto;">
                                            <button class="btn btn-success btn-sm" name="addCustBtn" id="addCustBtn" type="submit">Add Customer</button>
                                        </form>
                                    </div>
                                </div>
    ...
    $sql = "SELECT * FROM customer_master WHERE contact_type = 'Customer' AND business_id = '$business_id' ORDER BY created_on DESC";
} else {
    // Query to get customers for a specific branch, ordered by 'created_on' in descending order
     $sql = "SELECT * FROM customer_master WHERE contact_type = 'Customer' AND business_id = '$business_id' AND branch_id='$branch_id' ORDER BY created_on DESC";
}
                        //    echo $sql;            
