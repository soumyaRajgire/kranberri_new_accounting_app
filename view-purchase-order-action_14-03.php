...
<body class="">
    ...
    $query = "SELECT q.*, c.*, a.*, qi.*
              ...
              JOIN po_items qi ON q.id = qi.invoice_id
...
<div class="btn-group">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="margin-right: 55px;">
    <a class="dropdown-item" href="update_purchase_order.php?inv_id=<?php echo $inv_id; ?>">Edit Purchase Order</a>
        ...
        <a class="dropdown-item" href="delete_porder.php?inv_id=<?php echo $inv_id; ?>" onclick="return confirm('Are you sure you want to delete this invoice?');">Delete</a>
...
<!-- <iframe id="pdfViewer" src="<?php echo $quotationDetails['quotation_file']; ?>" width="100%" height="600px"></iframe> -->
...
<script>
   ...
   document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`fetch_porder_path.php?invoice_id=${invoiceId}`)
