...
<div class="mb-1 col-lg-6">
    ...
    <i class="bi bi-plus-circle" style="font-size: 1.5rem;"></i>
                        ...
                        <div class="mb-1 col-lg-3" id="priceFieldBlock">
                            <div class="did-floating-label-content">
                                <input type="number" id="price" name="price" class="did-floating-input modal-input price-input" data-modal="products" oninput="calculatePrices('products')" placeholder="" required>
                                <label for="price" class="did-floating-label">Price</label>
                            </div>
                        </div>
                        <div class="mb-1 col-lg-3">
                            <div class="did-floating-label-content">
                               <select id="inclusive_gst" name="inclusive_gst" class="did-floating-select modal-select inclusive-gst-select" data-modal="products" onchange="calculatePrices('products')" required>
    ...
    <option value="exclusive of GST">Exclusive of GST</option>
                        ...
                        <div class="mb-1 col-lg-3">
                           <div class="did-floating-label-content">
                                <select id="gst_rate" name="gst_rate" class="did-floating-select modal-select gst-rate-input" data-modal="products" onchange="calculatePrices('products')" required>
                        ...
                        <div class="mb-1 col-lg-3" id="nontaxableFieldBlock">
                            <div class="did-floating-label-content">
                                <input type="number" id="non_taxable1" name="non_taxable" step="0.01" class="did-floating-input non-taxable-input modal-input" data-modal="products" placeholder="" oninput="calculatePrices('products')">
                        ...
                        <div class="mb-1 col-lg-3">
    <div class="did-floating-label-content">
    <input type="number"  id="cess_rate1"   name="cess_rate"   class="did-floating-input modal-input cess-amt-input"  placeholder="" data-modal="products" oninput="calculatePrices('products')">
...
<div class="mb-1 col-lg-3" id="cessamtFieldBlock">
    ...
    <label for="cess_amount" class="did-floating-label">CESS Amount</label>
                        ...
                        <!-- <div class="mb-1 col-lg-3" id="maintainBatchContainer" >
                            <div class="text-center">
                                <label class="form-check-label">
                                    <input type="checkbox" id="maintain_batch" name="maintain_batch" class="form-check-input">
                                   Maintain Batch
                                </label>
                            </div>
                        </div> -->
...
<!-- <div class="mb-1 col-lg-3" id="manufacturerField" style="display: none;">
    <div class="did-floating-label-content">
        <select class="did-floating-select modal-select units-select" data-modal="products" name="manufacturer" id="manufacturer" required>
            <?php
                // Your PHP code to fetch manufacturers
                if (!isset($_SESSION['branch_id'])) {
                    $business_id = $_SESSION['business_id'];
                    $sql = "SELECT * FROM customer_master WHERE contact_type = 'Manufacturer' ORDER BY created_on DESC";
                } else {
                    $business_id = $_SESSION['business_id'];
                    $sql = "SELECT * FROM customer_master WHERE contact_type = 'Manufacturer' ORDER BY created_on DESC";
                }
...
<div class="mb-1 col-lg-3" id="mfgDateField" style="display: none;">
    <div class="did-floating-label-content">
        <input type="date" id="mfg_date" name="mfg_date" class="did-floating-input modal-input" placeholder="">
        <label for="mfg_date" class="did-floating-label">Mfg Date</label>
    </div>
</div>

<div class="mb-1 col-lg-3" id="expDateField" style="display: none;">
    <div class="did-floating-label-content">
        <input type="date" id="exp_date" name="exp_date" class="did-floating-input modal-input" placeholder="">
        <label for="exp_date" class="did-floating-label">Exp Date</label>
    </div>
</div>

<div class="mb-1 col-lg-3" id="batchNoField" style="display: none;">
    <div class="did-floating-label-content">
        <input type="text" id="batch_no" name="batch_no" class="did-floating-input modal-input" placeholder="">
...
function addBatchRow() {
    ...
    <div class="row batch-row mb-2 border p-2 rounded">
        ...
        <div class="mb-1 col-lg-3">
            <div class="did-floating-label-content">
                <select name="manufacturer[]" class="did-floating-select modal-select units-select" required>
                    ...
                    <!-- PHP code for manufacturers will be injected here -->
                </select>
                <label for="manufacturer" class="did-floating-label">Select Manufacturer</label>
            </div>
        </div>
        ...
        <div class="mb-1 col-lg-3">
            <div class="did-floating-label-content">
                <input type="number" name="batch_price[]" class="did-floating-input modal-input batch-price-input" data-modal="products" placeholder="" oninput="calculateBatchRow(this)" required>
                <label for="price" class="did-floating-label">Price</label>
            </div>
        </div>
