    ...
    <div class="table-responsive">
      <div class="row">
        <div class="col-sm-12">
          <div class="">
            <div class="card-body">
              <form action="porderdb.php" method="POST" enctype="multipart/form-data">
...
GSTIN: 29AAICK7493G1ZX<br/>
  ...
  $order_code = "POR0".(1);
                          ...
                          ?>
              <input class="form-control" type="text" id="orderNo" value="<?php echo $order_code; ?>" name="orderNo" />
                <label class="form-control col-sm-5" for="orderNo">Purchase Order No</label>
                
                        </div>
                        <div class="py-1 input-group">
                            <input class="form-control" type="date" id="orderDate" name="orderDate" required/>
                            <label class="form-control col-sm-5" for="orderDate">Order Date</label>
                        </div>
                        <div class="py-1 input-group">
