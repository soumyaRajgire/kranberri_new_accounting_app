                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">GST Purchase Details Report</h4>
                            </div>
                            <ul class="breadcrumb" style="float: right; margin-top:-40px;">
                                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">GST Purchase Details Report</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5>View GST Purchase Details Reports</h5>
...
<div id="reportsSidebar">
    ...
    <h4>Reports</h4>
    <h6>GST Purchase Details Report</h6>
<hr>
...
<hr>
    ...
    <!-- <div>
        <p><b>Product Purchase Report</b> (01-12-2024 - 05-03-2025) <a href="#" class="btn btn-info btn-sm">Download</a></p>
        <p><b>Product Purchase Report</b> (01-12-2024 - 05-03-2025) <a href="#" class="btn btn-danger btn-sm">Download</a></p>
    </div> -->
</div>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Fetch Data Function
    function fetchDeliveryChallanData() {
    $.ajax({
        url: "fetch_gst_purchase_report_details.php",
        method: "POST",
        data: {
