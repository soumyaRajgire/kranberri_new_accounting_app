...
$itemQuery = "SELECT i.id , i.productid, i.product, i.prod_desc, i.batch_no, i.qty, i.price, i.discount, i.gst, i.cgst, i.sgst, i.igst, i.cess_rate, i.cess_amount, i.total,  IFNULL(SUM(ci.qty), 0) AS credited_qty, ci.cgst as ccgst ,ci.sgst as csgst,ci.igst as cigst
