...
if (isset($_GET['inv_id']) && !empty($_GET['inv_id'])) {
  ...
  $query = $conn->prepare("
    SELECT DISTINCT 
        pi.id as invoice_id, pi.invoice_code, pi.invoice_date, pi.due_date, pi.total_amount, pi.terms_condition, pi.note, pi.status,pi.total_cess,pi.total_gst,cm.customerName, cm.email, cm.gstin, cm.business_name,cm.id as cmid, 
 ...
 pii.id as item_id,pii.productid, pii.product, pii.invoice_id, pii.prod_desc, pii.qty, pii.price, pii.discount,pii.line_total, pii.gst, pii.cgst, pii.sgst, pii.igst, pii.cess_rate, pii.cess_amount, pii.total
    ...
    JOIN po_items pii ON pi.id = pii.invoice_id
        ...
        <div class="pcoded-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">Edit Purchase Order</h4>
                            </div>
            ...
            <div class="col-xl-12">
              ...
              <div class="col-sm-12">
                <div class="">
                  <div class="card-body">
                            <form action="update_porderdb.php" method="POST" enctype="multipart/form-data">
...
<input type="text" name="business_state" id="business_state" value="<?php echo htmlspecialchars($user['state']); ?>" hidden>
                                    ...
                                    <div class="col-md-4 pt-1">
                                        <div class="py-1 input-group">
                                            <input class="form-control" type="text" id="invoice_code" value="<?php echo htmlspecialchars($invoice_code); ?>" name="invoice_code" />
                                            <label class="form-control col-sm-5" for="invoice_code">Purchase Order No</label>
                                        </div>
                                        <div class="py-1 input-group">
                                        <input class="form-control" type="date" id="invoice_date" name="invoice_date" value="<?php echo isset($invoice_date) ? htmlspecialchars(date('Y-m-d', strtotime($invoice_date))) : ''; ?>" required />
                                            <label class="form-control col-sm-5" for="invoice_date">Order Date</label>
                                        </div>
                                        <div class="py-1 input-group">
                                        <input class="form-control" type="date" id="due_date" name="due_date" value="<?php echo isset($due_date) ? htmlspecialchars(date('Y-m-d', strtotime($due_date))) : ''; ?>" required />
...
<!-- <td data-field="cess_amount"><span><?php echo $item['cess_amount']; ?></span></td> -->
                ...
                <div class="col-md-6 border-right border-bottom border-dark p-1">
                 ...
                 <tr>       
                     ...
                     <td style="text-align:right;" id="final_taxable_amt"><?php echo $invoice_details['total_amount']?> </td>
                   
                </tr> 
          
                <tr>
                    <td class="" style="width: 60%;vertical-align: middle;border-right: 1px solid #ada7a7;border-bottom: 0px;">Total GST</td>
                    <td style="text-align:right;" id="final_gst_amount" > <?php echo $invoice_details['total_gst']?></td>
                     
                </tr>

                <tr>
                    <td class="" style="width: 60%;vertical-align: middle;border-right: 1px solid #ada7a7;border-bottom: 0px;">Total Cess</td>
                    <td style="text-align:right;" id="final_cess_amount" ><?php echo $invoice_details['total_cess']?></td>
