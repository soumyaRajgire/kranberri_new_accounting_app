		...
		<div class="navbar-wrapper  ">
			...
			<!-- 	<div class="">
					...
					<div class="main-menu-header">
						<img class="img-radius" src="<?php echo $row["logoimage"]; ?>" alt="User-Profile-Image">
				...
				?> -->
					...
					<li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
							...
							<li><a href="other_contacts.php">Other Contacts</a> </li>
							<li><a href="deleted_contacts.php">Deleted Contacts</a> </li>
					...
					<li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
					         <li><a href="purchase_invoices.php">Purchase Invoices</a></li>
                             <li><a href="purchase_invoices.php?voucherCard">Expense Vouchers</a> </li>
                             <li><a href="purchase_invoices.php?AccountsCard">Accounts Payables</a> </li>
					    </ul>
					</li>
