...
while ($row2 = $result2->fetch_assoc()) {
   ...
   <?php
    ...
    <i class="bi bi-plus-circle" style="font-size: 1.5rem;"></i>
                        ...
                        <option value="inclusive of GST" <?php if ($row['in_ex_gst'] === 'inclusive of GST') echo 'selected'; ?>>Inclusive of GST</option>
                        <option value="exclusive of GST" <?php if ($row['in_ex_gst'] === 'exclusive of GST') echo 'selected'; ?>>Exclusive of GST</option>
                    </select>
                            </div>
                        </div>
                        <div class="mb-1 col-lg-3">
