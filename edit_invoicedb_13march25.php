...
$previous_quantities = []; // Store previous values for each product
...
// Step 3: Update inventory only if quantity has changed
if ($qtyvalue != $prev_qty) {
      // echo "<script>alert('vefore additional charges  update created successfully".$prev_qty."');</script>";
    if ($qtyvalue > $prev_qty) {
