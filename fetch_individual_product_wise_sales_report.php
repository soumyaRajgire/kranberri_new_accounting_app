...
$from_date_sql = !empty($from_date) ? date("Y-m-d", strtotime(str_replace('/', '-', $from_date))) : '';
$to_date_sql = !empty($to_date) ? date("Y-m-d", strtotime(str_replace('/', '-', $to_date))) : '';
...
if (!empty($from_date_sql)) {
    $sql .= " AND i.invoice_date >= ?";
}
if (!empty($to_date_sql)) {
    $sql .= " AND i.invoice_date <= ?";
}
