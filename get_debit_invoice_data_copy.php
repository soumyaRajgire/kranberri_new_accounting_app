...
if (isset($_GET['invoiceID'])) {
    ...
    // Fetch invoice item details with DISTINCT to avoid duplicates
    $itemQuery = "
    ...
    if ($stmt->execute()) {
        ...
        while ($row = $itemResult->fetch_assoc()) {
            ...
            if (!isset($items[$productId])) {
                $items[$productId] = $row;  // Avoid duplicate entries
            }
        }
    } else {
    ...
    $additionalChargesQuery = "
        SELECT charge_type, charge_price 
