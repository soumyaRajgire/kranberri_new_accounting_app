                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    PAN : <?php echo $row["pan"] === "" ? '<a href="update-supplier.php?id=' . $row["id"] . '">Update PAN</a>' : $row["pan"]; ?><br/>
                                                    GSTIN : <?php echo $row["gstin"] === "" ? '<a href="update-supplier.php?id=' . $row["id"] . '">Update GSTIN</a>' : $row["gstin"]; ?>
                                                </td>
                                                <td>
