...
");
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td> <a href="'.$row['invoice_file'].'"" class="btn-sm btn btn-primary" download><i class="fa fa-download"></i></a><a href="mail-quotation.php?id='.$row['iid'].'&qcode='.$row['quotationNumber'].'" class="btn btn-primary btn-sm"><i class="fa fa-envelope"></i></a></td>';
