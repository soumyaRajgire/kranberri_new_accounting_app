...
<head>
 ...
 <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> 
<script src="assets/js/plugins/bootstrap.bundle.min.js"></script> <!-- Ensure this path is correct -->
...
<body class="">
    ...
    <section class="pcoded-main-container">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">Bill Of Supply</h4>
      ...
      <!-- Search Input -->
      <input type="text" class="form-control mr-2" placeholder="Search BOS">
      
      <!-- Sort Button -->
      <button class="btn btn-outline-primary btn-sm mr-2"><i class="bi bi-sort-down"></i></button>
      
      <!-- Funnel Button with Dropdown -->
            ...
            <div class="col-lg-3">
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Total Paid
                        <span class="badge bg-primary rounded-pill">INR 0</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Fully Paid
                        <span class="badge bg-success rounded-pill">INR 0</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Part Paid
                        <span class="badge bg-info rounded-pill">INR 0</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Recievables
                        <span class="badge bg-danger rounded-pill">INR 0</span>
                    </li>
...
<script src="assets/js/pcoded.min.js"></script>
 ...
 <script src="path/to/jquery.js"></script> <!-- Update with your jQuery path -->
  <script src="path/to/bootstrap.bundle.js"></script> <!-- Update with your Bootstrap path -->
<script>
