                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">Product Wise Purchase Report</h4>
                            </div>
                            <ul class="breadcrumb" style="float: right; margin-top:-40px;">
                                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">Product Wise Purchase Report</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5>View Product Wise Purchase Report</h5>
...
<div id="reportsSidebar">
    ...
    <h4>Reports</h4>
    <h6>Product Wise Purchase Report</h6>
<hr>
...
<div id="recentReports">
    ...
    // Function to format date as yyyy-mm-dd (for MySQL queries)
    ...
    // Ensure consistency in case the previous month has fewer days
    if (lastMonth.getDate() !== today.getDate()) {
        lastMonth.setDate(0); // Adjust to the last valid date of the previous month
    }

    // Format dates for display and backend
    ...
    // Main Date Inputs (only these should affect the table data)
    ...
    // Sidebar Date Inputs (should not affect the table)
    ...
    // Initialize Flatpickr for sidebar date inputs (no effect on table)
    ...
    // Function to fetch stock data with converted dates (only for main dates)
    function fetchStockData() {
        ...
        $.ajax({
            url: "fetch_product_wise_purchase_report.php",
            method: "POST",
            data: {
...
document.addEventListener("DOMContentLoaded", function () {
    document.querySelector(".btn-dark").addEventListener("click", function () {
        ...
        $.ajax({
            url: "generate_product_wise_purchase_report.php",
            method: "POST",
            data: { from_date: fromDate, to_date: toDate, report_type: reportType },
            success: function (response) {
                alert("Report generated successfully.");
                updateRecentReports(); // Refresh recent reports section
            },
            error: function () {
    ...
    function updateRecentReports() {
        $.ajax({
            url: "fetch_recent_product_wise_purchase_reports.php",
            method: "GET",
            success: function (data) {
