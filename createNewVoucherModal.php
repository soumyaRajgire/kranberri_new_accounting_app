...
<div id="newVoucherModal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    ...
    <form action="newvoucherdb.php"  id="addreceiptForm" method="POST" enctype="multipart/form-data" >
...
alert(customerId);
        if (customerId) {
            $.ajax({
                url: 'fetch_unpaid_pinvoices.php', // Endpoint to fetch unpaid invoices
                type: 'GET',
