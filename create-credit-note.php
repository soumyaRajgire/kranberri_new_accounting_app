...
<input type="text" name="business_state" id="business_state" value="<?php echo htmlspecialchars($user['state']); ?>" hidden>
                    ...
                    <div class="py-1 input-group">
                      ...
                      ?>
                      <input class="form-control" type="text" id="debitNoteNo" value="<?php echo $debit_note_code; ?>" name="debitNoteNo"  required readonly />
          ...
          <div class="col-md-3 p-1 border-right border-left border-bottom">
              ...
              <input type="number" name="itemno" id="itemno" select-group="" data-count=1 hidden />
                    ...
                    <!-- <input class="form-control" list="product" name="product_choice" id="product_choice" placeholder="Product" /> -->
                           <!-- Once an invoice is selected, dynamically load its products excluding already credited ones -->
<!-- <select class="form-control" id="productChoice" name="product_choice"> -->
    <!-- <option value="">Select Product</option> -->
    <!-- This will dynamically load products once an invoice is selected -->
<!-- </select> -->
...
//             // Assuming data contains the HTML to populate customer data
//             $("#customer_dp").hide();
//             $("#customer_data").html(data);

//             // Set hidden fields
//             $('#customer_name_choice').val(params.customername);
//             $('#customer_email').val(params.customer_email); // Ensure data has the email value
//             $('#cst_mstr_id').val(params.customerID);
//         },
...
$(document).ready(function () {
    ...
    function fetchInvoiceData(invoiceId) {
      alert(invoiceId);
        $.ajax({
            url: 'get_credit_invoice_data.php',
            type: 'GET',
                ...
                try {
                    ...
                    if (response.message === 'No product to credit for this invoice.') {
                        Swal.fire({
                            ...
                            text: 'There are no products to credit for this invoice.',
...
gt = lineTotal + gstAmt + cessAmt;
 ...
 totcessamt = totcessamt + cessAmt;
            ...
            {
              console.log("from credited qty i s0");
...
/**
 * Function to recalculate GST, Cess, and Total for a row
 */
