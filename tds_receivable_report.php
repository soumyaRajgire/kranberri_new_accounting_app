                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">TDS Summary Receivable</h4>
                            </div>
                            <ul class="breadcrumb" style="float: right; margin-top:-40px;">
                                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">TDS Summary Receivable</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5>View TDS Summary Receivable</h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                        ...
                                        <th>PAN No.</th>
                                        <th>Total</th>
                                        <th>Total After TDS Deduction</th>
                                        <th>Tax Deducted at Source</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
    <td>Jhon</td> <!-- Vendor Name -->
    <td>ABCDE1234F</td> <!-- PAN No. -->
    <td>₹50,000</td> <!-- Total -->
    <td>₹47,500</td> <!-- Total After TDS Deduction -->
    <td>₹2,500</td> <!-- Tax Deducted at Source -->
</tr>
