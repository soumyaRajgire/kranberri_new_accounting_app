...
// Set the E-way Bill cancellation URL
//$ewayBillCancelUrl = "https://gsp.adaequare.com/enriched/ei/api/ewayapi";
$ewayBillCancelUrl = "https://gsp.adaequare.com/test/enriched/ei/api/ewayapi";

// Prepare the data to send in the request body
$data = [
    'ewbNo' => $e_way_bill_no,  // E-way bill number to cancel
    'cancelRsnCode' => '4',     // Cancellation reason code
    'cancelRmrk' => 'Other',    // Remarks for cancellation
];
...
$ewayBillCancelResponse = $client->post($ewayBillCancelUrl, [
    'headers' => [
        'Content-Type' => 'application/json',  // Content type
        'user_name' => $user_name,             // Your user name
        'password' => $password,               // Your password
...
$ewayBillCancelResponseBody = json_decode($ewayBillCancelResponse->getBody(), true);

// Print the response to see what we get back from the server
echo "<pre>"; print_r($ewayBillCancelResponseBody); echo "</pre>";
