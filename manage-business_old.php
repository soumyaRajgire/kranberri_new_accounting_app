...
<section class="pcoded-main-container">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" id="gstin" name="gstin" disabled="" class="form-control" placeholder="GST Number" value="">
                        </div>

                        <h6 class="control-label">Constitution of Business</h6>
                        <select id="constitution" name="constitution" class="form-control" required="">
                    ...
                    <div class="col-6">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" id="alias_name" name="alias_name" class="form-control" placeholder="Alternate Business Name" value="">
                        </div>
                        <div class="form-group mb-2">
                            <h6 class="control-label" >Mobile Number<span class="required"> * </span></h6>
                            <input type="text" id="mobile" name="mobile" class="form-control" placeholder="Mobile Number" value="" required>
                        </div>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" id="address1" name="address1" class="form-control" placeholder="Address Line 1" value="" required>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group mb-2">
                            <h6 class="control-label">Address Line 2<span class="required"> * </span></h6>
                            <input type="text" id="address2" name="address2" class="form-control" placeholder="Address Line 2" value="" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-3">
                        ...
                        <input type="text" id="pincode" name="pincode" class="form-control" placeholder="Pin Code" value="" required>
                    </div>
                    <div class="col-3">
    ...
    <div class="row"> 
        <div class="col-6">
            ...
            <div class="form-group mb-2">
                <input type="text" id="eway_user" name="eway_user" class="form-control" placeholder="E-Way User" value="">
            </div>
        </div>
        <div class="col-6">
            <div class="orm-group mb-2">
                <input type="password" id="eway_password" name="eway_password" class="form-control" placeholder="Password" value="">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-6">           
            <div class="form-group mb-2">
                <input type="text" id="gov_user" name="gov_user" class="form-control" placeholder="Gov. User" value="">
            </div>
             </div>
        <div class="col-6">
            <div class="form-group mb-2">
                <input type="password" id="gov_password" name="gov_password" class="form-control" placeholder="Password" value="">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="form-group mb-2">
                <input type="text" id="einv_user" name="einv_user" class="form-control" placeholder="E-Inv. User" value="">
            </div>
            </div>
        <div class="col-6">
            <div class="form-group mb-2">
                <input type="password" id="einv_password" name="einv_password" class="form-control" placeholder="Password" value="">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group mb-2">
                <input type="text" id="bank_upi" name="bank_upi" class="form-control" placeholder="Bank UPI" value="">
            </div>
            </div>
        <div class="col-6">
            <div class="form-group mb-2">
                <input type="text" id="payee_name" name="payee_name" class="form-control" placeholder="Payee Name" value="">
            </div>
        </div>
    </div>
                ...
                <div class="col-9 mt-1">
                    <div class="card">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row" style="color: #00acc1;">ADMIN <br> 
                                    <button href="#addBranchModal" data-toggle="modal" id="btn-gstin" style="background-color: #00acc1; border-color: #00acc1; color: white;">
                                    Update GSTIN</button></th>
                                    <td  style="color: #74788d;">admin@gmail.com <br> 9999999999</td>
                                    <td style="color: #74788d;">Hyderabad <br> Telangana </td>
                                </tr>
                            </tbody>
                        </table>
                        </div>
        ...
        <div class="modal-content" style="border-radius: 5px;">
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="gstin-tab" data-toggle="tab" href="#gstin" role="tab" aria-controls="gstin" aria-selected="true">GSTIN</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content mt-3" id="myTabContent">
                    <!-- GSTIN Tab -->
                    <div class="tab-pane fade show active" id="gstin" role="tabpanel" aria-labelledby="gstin-tab">
                        <form id="gstinForm">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="gstin_input">GSTIN</label>
                                    <input type="text" class="form-control" id="gstin_input" name="gstin_input" placeholder="Enter GSTIN" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                            <div class="form-group col-md-6">
                                    <label for="scheme">Select GST Filing Scheme</label>
                            ...
                            <!-- Add more fields related to GSTIN if needed -->
                        </form>
                    </div>
                    ...
                    <div class="tab-pane fade" id="info" role="tabpanel" aria-labelledby="info-tab">
                        <form id="infoForm">
                            <!-- Add fields for information here -->
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="ofc_email">Office Email Address</label>
                                    <input type="text" class="form-control" id="ofc_email" name="ofc_email" placeholder="Enter Office Email" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="ofc_number">Office Telephone Number</label>
                                    <input type="text" class="form-control" id="ofc_number" name="ofc_number" placeholder="Enter Office Number" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                <label for="others">Nature of Premises</label>
                                    <select class="form-control" id="others" name="others" required>
                            ...
                            <!-- Add more fields for information if needed -->
                        </form>
                    </div>
                </div>
            </div>
