...
<div class="col-6" id="credit_debit_card_tab" style="display: none;">
    <div class="form-group">
        ...
        <input type="text" class="form-control m-input form-control-sm"
       id="card_last_no"
       name="card_last_no"
       placeholder="Card last 4 digit No"
       pattern="\d{4}"
       maxlength="4"
       inputmode="numeric"
       title="Enter exactly 4 digits"><label ></label>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const cardInput = document.getElementById("card_last_no");
        const cardTab = document.getElementById("credit_debit_card_tab");

        function toggleCardField() {
            const selectedMode = paymentMode.value;
        ...
        paymentMode.addEventListener("change", toggleCardField);
        toggleCardField(); // Call on page load to initialize visibility
    });
</script>
