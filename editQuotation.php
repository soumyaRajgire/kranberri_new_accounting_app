        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <div class="page-header-title">
              <h4 class="m-b-10">Edit Quotation</h4>
            </div>
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
              <li class="breadcrumb-item"><a href="#">Quoatation</a></li>
          ...
          <div class="table-responsive">
            <div class="row">
              <div class="col-sm-12">
                <div class="">
                  <div class="card-body">
                    <form action="editQuotationdb.php" method="POST" enctype="multipart/form-data">
...
?>
    ...
    <div class="additional-charges-list">
        ...
        <?php } ?>
                ...
                <!-- <input type="hidden" name="delete_item_ids" id="delete_item_ids"> -->
...
const hsn_code = parseFloat($('#hsn_code').val()) || 0; 
  ...
  let basePrice = 0;
    ...
    $('#item-list tbody tr').each(function () {
        let existingProduct = $(this).find('input[name*="[pname]"]').val();
    ...
    if (duplicateFound) {
        alert("This product is already selected. Please update the existing row.");
         $('#product_choice').val('');
        $('#productid').val('');
        $('#prod_desc').val('');
        $('#qty').val(1);
         ...
         <td>${product}<input type="hidden" name="products[${count}][pname]" value="${product}"><input type="hidden" name="products[${count}][pproductid]" value="${productid}"></td>
          ...
          <input type="hidden" class="form-control" name="products[${count}][phsn_code]" value="${hsn_code}" >
           <input type="hidden" class="form-control" name="products[${count}][punits_val]" value="${units}" >
            ...
            <td><button type="button" class="btn btn-sm btn-outline-danger remove-item">
...
totalTaxable = totalTaxable + totalAmount;
   ...
   $('#final_taxable_amt').text(totalTaxable.toFixed(2));
    ...
    calc_total(); // Recalculate totals after deleting an item
});
...
$(".delete-item").click(function () {
    ...
    if (confirm("Are you sure you want to delete this item?")) {
        ...
        // **Fix: Call `calc_total()` after deleting**
        calc_total();
    }
});
