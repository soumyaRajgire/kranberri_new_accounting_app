...
if(isset($_POST['submit']))
{
 ...
 $createdBy =  $_SESSION['name'];
       $sql = "insert into suppliers(name,business_Name,PanNo,gst_reg_type,gst_no,address,city,state,pincode,country,phone,mobile,email,createdBy) values('$name','$business_name','$panno','$gst_reg_type','$gst_no','$address','$city','$state','$pincode','$country','$phno','$mobno','$email','$createdBy')";
            ...
            if ($conn->query($sql) === TRUE) 
          {
              ...
              <script>
                ...
                alert("Suppliers details Added Successfully");
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Add Suppliers</a></li>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a  href="view-suppliers.php" class="btn btn-info" style="color: #fff !important;float:right;" /> View Supplier</a>
                    </div>
