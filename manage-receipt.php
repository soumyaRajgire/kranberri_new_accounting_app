...
<body class="">
   ...
   <?php include("createNewReceiptModal.php"); ?>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h4 class="m-b-10">Manage Receipt</h4>
                        </div>
                        <ul class="breadcrumb" style="float: right; margin-top:-40px;" >
                            <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Manage Receipt</a></li>
...
FROM receipts re
LEFT JOIN invoice i ON re.invoice_id = i.id -- Directly linked invoice (single invoice case)
LEFT JOIN reconciliation r ON re.id = r.receipt_id -- Reconciliation table for multiple invoices
LEFT JOIN invoice i2 ON r.invoice_id = i2.id -- Fetch invoice codes for multiple reconciled invoices
LEFT JOIN customer_master cm ON re.customer_id = cm.id -- Customer details
GROUP BY re.id
ORDER BY  re.recpt_id DESC";
    ...
    <div class="card" style="border-radius: 5px;">
         <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">
                        ...
                        <form class="form-inline" method="POST" action="download_receipt_monthly.php" style="display: flex; align-items: center; margin-right: 10px;">
                        ...
                        <form class="form-inline" method="POST" action="download_receipt_range.php" style="display: flex; align-items: center; margin-right: 10px;">
                        ...
                        <a href="#" data-toggle="modal" data-target="#newReceiptsModal"  class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Open Link">Create</a>
                    </div>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
       echo "<tr>
        ...
        <td>
            <a href='view-receipt-action.php?receiptId=" . $row['recptid'] . "'>" . $row["recpt_id"] . "</a><br>" . $row["receipt_date"] . "
        </td>
        <td>
            INR " . $row["paid_amount"] . "<br>" . $row["payment_mode"] . "
        </td>
        <td>
            <a href='view-invoice-action.php?inv_id=" . $row['invoice_id'] . "'>" . $row["invoice_code"] . "</a><br>
