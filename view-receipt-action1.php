...
<?php include("edit_receipt.php"); ?>
  ...
  $sql = "SELECT 
            ...
            br.city,
            br.state
        FROM add_business AS br 
        WHERE br.business_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $businessId);
$stmt->execute();
$stmt->bind_result($business_name, $GSTIN, $email, $mobile_number, $address_line1, $address_line2, $pincode, $city, $state);
...
?>
  ...
  <span class=""><?php echo htmlspecialchars($business_name); ?></span>
<span id="seller_add_1" class="line-height-70"><?php echo htmlspecialchars($address_line1); ?></span>
<span id="seller_add_2" class="line-height-70"><?php echo htmlspecialchars($address_line2); ?></span>
<span id="seller_add_3" class="line-height-70"><?php echo htmlspecialchars($city . " - " . $pincode); ?></span>
<span id="seller_add_4" class="line-height-70"><?php echo htmlspecialchars($state . " - INDIA"); ?></span>

<!-- You can also add other fields, like email and phone -->
<span id="seller_email" class="line-height-70"><?php echo htmlspecialchars($email); ?></span>
<span id="seller_phone" class="line-height-70"><?php echo htmlspecialchars($mobile_number); ?></span>
<span id="seller_gstin" class="line-height-70"><?php echo htmlspecialchars($GSTIN); ?></span>
                        ...
                        <h6 class="line-height-72" style="text-align:left;"> Receipt Date:  </h6> 
                         <h6 class="line-height-70" style="text-align:left;"> 
                            <span id="rec_date">
                                <?php 
                                    if ($receiptDetails && isset($receiptDetails['receipt_date'])) {
                                        // Format the date in DD/MM/YYYY format
                                        echo date('d/m/Y', strtotime($receiptDetails['receipt_date']));
                                    } else {
                                        echo '';
                                    }
                                ?>
                ...
                <tr>
                    <td style="vertical-align: top;" class="p-1">
                         <h6 class="line-height-72" style="text-align:left;"> Receipt Number::  </h6> 
                         <h6 class="line-height-70" style="text-align:left;"> <span id="rec_no"><?php echo $receiptDetails ? $receiptDetails['recpt_id'] : ''; ?></span> </h6>
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <h6 class="line-height-70"><?php echo $receiptDetails ? $receiptDetails['bank_name'] : ''; ?></h6>
                     ...
                     <h6 class="line-height-70"> <?php echo $receiptDetails ? numberToWordsFloat($receiptDetails['paid_amount']) : ''; ?></h6>
                     </td>
