    ...
    foreach ($_POST["products"] as $key => $product) {
       ...
       // $totalval = $qtyvalue * $priceval; 
        ...
        // Insert into database (if needed)
         $sql_insert = "INSERT INTO `billsupply_items` (`bill_id`, `itemno`, `product`, `qty`, `price`,`discount`,`line_total`,`total`,`product_id`, `batch_no`) 
                VALUES ('$id', '$item', '$product', '$qtyvalue', '$priceval','$discount_amount','$line_tot', '$totalval','$productids', '$batch_no')";
