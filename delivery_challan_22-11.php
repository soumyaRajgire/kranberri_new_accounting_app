...
GSTIN: 29AAICK7493G1ZX<br/>
  ...
  $invoice_code = "INV0".(1);
                          ...
                          ?>
              <input class="form-control" type="text" id="purchaseNo" value="<?php echo $invoice_code; ?>" name="purchaseNo" />
<select class="form-control" name="purchaseNo">
    <option value="cal">cal</option>
    <option value="fin">fin</option>
</select>
              <label class="form-control col-sm-5" for="purchaseNo">Challan No</label>
                
                        </div>
                        <div class="py-1 input-group">
                            <input class="form-control" type="date" id="purchaseDate" name="purchaseDate" required/>
                            <label class="form-control col-sm-5" for="purchaseDate">Challan Date</label>
                        </div>
                        <div class="py-1 input-group">
