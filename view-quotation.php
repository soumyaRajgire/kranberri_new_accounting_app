        ...
        <div class="card">
            <div class="card-header">
                <h5>View Quotation Details</h5>
                    ...
                    <form class="form-inline" method="POST" action="download_quotation_monthly.php" style="display: flex; align-items: center; margin-right: 10px;">
                    ...
                    <form class="form-inline" method="POST" action="download_quotation_range.php" style="display: flex; align-items: center; margin-right: 10px;">
                    ...
                    <a href="create-quotation.php" class="btn btn-info" style="color: #fff !important;">Create</a>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    ...
                    ");
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<td><a href="view-estimate-action.php?qid='.$row['qid'].'">' .$row['quotationNumber'] . '</a><br/>'.$row['invoice_date'].'</td>';
                                echo '<td>' . $row['grand_total'] . '<br/>'. $row['status'].'</td>';
                                echo '<td>' . $row['quotationCreatedOn'].'<br/>'.$row['quotationCreatedBy']. '</td>';
                                echo '<td>
                                <a href="'.$row['quotation_file'].'" target="_blank" class="btn-sm btn btn-primary" download><i class="fa fa-download"></i></a>
                                <a href="mail-quotation.php?id='.$row['qid'].'&qcode='.$row['quotationNumber'].'" class="btn btn-primary btn-sm"><i class="fa fa-envelope"></i></a>
                                <a href="edit-quotation.php?id='.$row['qid'].'" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                            </td>';
