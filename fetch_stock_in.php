...
if (isset($_POST['product_id'])) {
    ...
    $sql = "SELECT add_and_deduct, reference_no,remark, quantity, DATE_FORMAT(created_on, '%d/%m/%Y') AS date 
            FROM stock_master 
            WHERE product_id = ? AND add_and_deduct IN ('add','Purchase', 'Credit Note') 
