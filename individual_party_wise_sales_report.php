...
$customer_sql = "SELECT `customer_name` FROM `invoice` WHERE `customer_id` = '$customerid' LIMIT 1";
...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">Individual Party Wise Sales Report</h4>
                            </div>
                            <ul class="breadcrumb" style="float: right; margin-top:-40px;">
                                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">Individual Party Wise Sales Report</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <h4 class="text-center"><?php echo htmlspecialchars($customer_name); ?></h4>
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5>View Individual Party Wise Sales Reports</h5>
    ...
    <thead>
        <tr>
            ...
            <th>Invoice No.</th> <!-- Changed from Buyer Name -->
...
<div id="reportsSidebar">
    ...
    <h4>Reports</h4>
    <h6>Individual Party Wise Sales Report</h6>
<hr>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchInvoiceData() {
        ...
        $.ajax({
            url: "fetch_individual_party_wise_sales_report.php",
            method: "POST",
            data: {
