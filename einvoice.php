...
<a href="#" id="myBtn" data-invoice-id="<?php echo $inv_id; ?>" class="btn border border-grey" data-toggle="modal" data-placement="top" title="Open Link">E-Invoice</a>
       ...
       <?php
        ...
        ?>
        <a href="#" data-toggle="modal" data-target="#gstCredentialsModal"   data-irn="<?php echo $quotationDetails['irn_no']; ?>" class="btn border border-grey " data-toggle="tooltip" data-placement="top" title="Open Link"><?php echo $quotationDetails['irn_no']; ?>Cancel E-Invoice</a> 
