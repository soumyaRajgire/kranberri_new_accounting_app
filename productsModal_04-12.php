<div id="addProductsModal" class="modal fade" role="dialog">
    ...
    <div class="did-floating-label-content">
        <div class="d-flex align-items-center">
            ...
            <button type="button" class="btn btn-link p-0 ms-2" data-bs-toggle="modal" data-bs-target="#addCategoryModal">
...
<div class="mb-1 col-lg-6">
    <div class="did-floating-label-content">
        <div class="d-flex align-items-center">
            ...
            <button type="button" class="btn btn-link p-0 ms-2" data-bs-toggle="modal" data-bs-target="#addCompanyModal">
                <i class="bi bi-plus-circle" style="font-size: 1.5rem;"></i>
            </button>
        </div>
    </div>
