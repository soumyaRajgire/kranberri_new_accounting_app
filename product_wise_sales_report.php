                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">Product Wise Sales Report</h4>
                            </div>
                            <ul class="breadcrumb" style="float: right; margin-top:-40px;">
                                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">Product Wise Sales Report</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5>View Product Wise Sales Reports</h5>
...
<div id="reportsSidebar">
    ...
    <h4>Reports</h4>
    <h6>Product Wise Sales Report</h6>
<hr>
...
<div id="recentReports">
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchStockData() {
        ...
        $.ajax({
            url: "fetch_product_wise_sales_report.php",
            method: "POST",
            data: {
...
document.addEventListener("DOMContentLoaded", function () {
    document.querySelector(".btn-dark").addEventListener("click", function () {
        ...
        $.ajax({
            url: "generate_product_wise_sales_report.php",
            method: "POST",
    ...
    function updateRecentReports() {
        $.ajax({
            url: "fetch_recent_product_wise_sales_reports.php",
            method: "GET",
            success: function (data) {
