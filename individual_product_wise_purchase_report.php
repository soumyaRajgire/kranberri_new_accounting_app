...
if (isset($_GET['productid'])) {
    ...
    header("Location: product_wise_purchase_report.php");
    exit();
}

// Fetch the product name
$product_name_sql = "SELECT `product` FROM `pi_invoice_items` WHERE `productid` = '$productid' LIMIT 1";
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">Individual Product Wise Purchase Report</h4>
                            </div>
                            <ul class="breadcrumb" style="float: right; margin-top:-40px;">
                                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">Individual Product Wise Purchase Report</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <h4 class="text-center"><?php echo htmlspecialchars($product_name); ?></h4>
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5>View Individual Product Wise Purchase Reports</h5>
...
<div id="reportsSidebar">
    ...
    <h4>Reports</h4>
    <h6>Individual Product Wise Purchase Report</h6>
<hr>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $.ajax({
        url: "fetch_individual_product_wise_purchase_report.php",
        method: "POST",
        data: {
            productid: productid,
...
document.addEventListener("DOMContentLoaded", function () {
    document.querySelector(".btn-dark").addEventListener("click", function () {
        ...
        $.ajax({
            url: "generate_individual_product_wise_purchase_report.php",
            method: "POST",
            data: { 
                productid: productid, 
                from_date: fromDateForSQL, 
    ...
    function updateRecentReports() {
        $.ajax({
            url: "fetch_recent_individual_product_wise_purchase_reports.php",
            method: "GET",
            success: function (data) {
