          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="page-header-title">
                <h4 class="m-b-10">Create Delivery Challan</h4>
              </div>
              <ul class="breadcrumb">
    ...
    <div class="table-responsive">
      <div class="row">
        <div class="col-sm-12">
          <div class="">
            <div class="card-body">
              <form id="" action="delivery_challan_db.php" method="POST">
...
<span style="color:skyblue;">GSTIN: 29AAICK7493G1ZX</span>
                    ...
                    <div class="col-md-4 pt-1">
                        <div class="py-1 input-group">
                          <?php
                          $result1=mysqli_query($conn,"select id from delivery_challan where id=(select max(id) from delivery_challan)");
  ...
  $dc_code = "DC00".(1);
                          ...
                          ?>
              <input class="form-control" type="text" id="dc_code" value="<?php echo $dc_code; ?>" name="dc_code" readonly />
                <label class="form-control col-sm-5" for="dc_code">DC No</label>
                
                        </div>
                        <div class="py-1 input-group">
                            <input class="form-control" type="date" id="dc_date" name="dc_date" required/>
                            <label class="form-control col-sm-5" for="dc_date">Challan Date</label>
                        </div>
                        <div class="py-1 input-group">
...
<script>
    ...
    document.getElementById('dc_date').value = formattedCurrentDate;
...
<div class="row" id="customer_data"></div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', (event) => {
        const purchaseDate = document.getElementById('dc_date');
