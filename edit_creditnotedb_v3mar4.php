...
$pdf->SetFont("Arial", "", 10);
$pdf->Cell(180, 6, "Note #: $cnote_code", 0, 1, 'R'); // Debit Note Number
$pdf->Cell(180, 6, "Note Date: $cnote_date", 0, 1, 'R'); // Date
//$sql = "SELECT  invoice_code FROM invoice WHERE id= '$purchase_invoice_id'";
$sql = "SELECT  invoice_code FROM invoice WHERE id= '$invoice_id'";
...
// Generate the alert message with all values
// echo "<script>
