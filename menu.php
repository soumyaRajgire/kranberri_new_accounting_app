	...
	<nav class="pcoded-navbar  ">
		...
		<!-- test menu-->
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="documents.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Documents</span></a>
					</li>
					<li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
					        ...
					        <li><a href="suppliers.php">Suppliers</a> </li>
							    <li><a href="view-manufacturer.php">Manufacturer</a></li>
					        <!-- <li><a href="view-employees.php">Employee</a></li> -->
					        <!-- <li><a href="layout-horizontal.html" target="_blank">Horizontal</a></li> -->
					    </ul>
					</li>

					<li class="nav-item pcoded-hasmenu">
					    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-hand-holding-usd"></i></span><span class="pcoded-mtext">Inventory</span></a>
					    <ul class="pcoded-submenu">
					        <li><a href="manage-products.php?type=Sales Catalog">Sales Catalog</a> </li>
                            <li><a href="manage-products.php?type=Purchased Items">Purchased Items</a></li>
                          
					    </ul>
					</li>

					<li class="nav-item pcoded-hasmenu">
					    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-hand-holding-usd"></i></span><span class="pcoded-mtext">Sales</span></a>
					    <ul class="pcoded-submenu">
					        <li><a href="view-invoices.php">Invoices</a> </li>
                            <li><a href="manage-receipt.php">Receipts</a></li>
                           	<li><a href="view-quotation.php">Quotation</a> </li>
                             <li><a href="manage_receivables.php">Receivables</a> </li> 
					    </ul>
					</li>

				
					<li class="nav-item pcoded-hasmenu">
					    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-comment-dollar"></i></span><span class="pcoded-mtext">Purchases</span></a>
					    <ul class="pcoded-submenu">
					         <li><a href="view-purchase-invoices.php">Purchase Invoices</a></li>
                             <li><a href="manage-voucher.php">Expense Vouchers</a> </li>
                             <li><a href="view-accounts-payables.php">Accounts Payables</a> </li>
					    </ul>
					</li>

					<li class="nav-item pcoded-hasmenu">
					    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-comment-dollar"></i></span><span class="pcoded-mtext">Taxation</span></a>
					    <ul class="pcoded-submenu">
					         <li><a href="gst-compliance.php">GST Compliance</a></li>
                             <li><a href="">TDS Compliance</a> </li>
                             <li><a href="">Income Tax Compliance</a> </li>
					    </ul>
					</li>
					<li class="nav-item">
					    <a href="manage-ledger.php" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Ledger </span></a>
					</li>
				
					<li class="nav-item pcoded-hasmenu">
					    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-users"></i></span><span class="pcoded-mtext">HR</span></a>
					    <ul class="pcoded-submenu">
					        <li><a href="view_employees.php">Employee</a></li>
                            <li><a href="view_attendence.php">Attendance</a></li>
                            <li><a href="payroll.php">Payrolls</a> </li>
					    </ul>
					</li>

					<li class="nav-item">
					    <a href="reports.php" class="nav-link "><span class="pcoded-micon"><i class="fas fa-file-alt"></i></span><span class="pcoded-mtext">Reports</span></a>
					</li>
					
					<!-- <li class="nav-item pcoded-hasmenu">
					    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-users"></i></span><span class="pcoded-mtext">Reports</span></a>
					    <ul class="pcoded-submenu">
					        <li><a href="view_employees.php">Employee</a></li>
                            <li><a href="view_attendence.php">Attendance</a></li>
                            <li><a href="payroll.php">Payrolls</a> </li>
					...
					<li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
					        <li><a href="all_invoices.php">Change Template</a></li>
                            <li><a href="">Change Format</a></li>
                            <li><a href="">Invoice Settings</a> </li>
							<li><a href="">Expense Settings</a> </li>
							<li><a href="">Sector Settings</a> </li>
							<li><a href="">Inventory Settings</a> </li>
							<li><a href="">Merge Products</a> </li>
							<li><a href="">Merge Buyers</a> </li>
							<li><a href="">Merge Sellers</a> </li>
					    </ul>
					</li>
